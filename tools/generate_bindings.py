...
DOTNET_NATIVE = ROOT / "dotnet" / "MkvCodec" / "Native" / "NativeMethods.cs"
DOTNET_METHODS = ROOT / "dotnet" / "MkvCodec" / "Native" / "NativeMethods.Generated.cs"
DOTNET_TYPES = ROOT / "dotnet" / "MkvCodec" / "Native" / "NativeTypes.Generated.cs"
...
_PYTHON_TYPES = {
    ...
    "mkvc_frame_copy_options": "FrameCopyOptions",
    ...
    "mkvc_pipeline_component_metrics": "PipelineComponentMetrics",
...
_DOTNET_TYPES = {
    ...
    "mkvc_frame_copy_options": "NativeFrameCopyOptions",
    ...
    "mkvc_pipeline_component_metrics": "MkvPipelineComponentMetrics",
...
_DOTNET_FIELD_NAMES = {
    ...
    "conversion_time_ns": "ConversionTimeNanoseconds",
