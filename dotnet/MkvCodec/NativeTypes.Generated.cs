...
public enum MkvPixelFormat : uint
{
    I420 = 1,
    Nv12 = 2,
    Bgr24 = 3,
...
public enum MkvGpuMemoryType : uint
{
    D3D11Texture = 1,
    VaSurface = 2,
    CudaPointer = 3,
...
public enum MkvGpuNativeHandleType : uint
{
    D3D11Texture = 1,
    VaSurface = 2,
    CudaPointer = 3,
...
public enum MkvSubmissionStatus : uint
{
    Pending = 0,
    Complete = 1,
    Failed = 2,
...
[StructLayout(LayoutKind.Sequential)]
internal struct NativeFrameView
{
    internal uint StructSize;
    internal uint StructVersion;
